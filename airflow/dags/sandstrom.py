...
args = {
    ...
    "start_date": dt.datetime(2023, 10, 29),  # Начальная дата выполнения DAG
...
with DAG(dag_id='iris_score', default_args=args, schedule_interval=None, tags=['iris']) as dag:
    ...
    get_data = BashOperator(task_id='get_data',
        bash_command='python3 /home/anton/mlops3/scripts/get_data.py',
        dag=dag)
    ...
    train_test_split = BashOperator(task_id='train_test_split',
        bash_command='python3 /home/anton/mlops3/scripts/train_test_split.py',
        dag=dag)
    ...
    train_model = BashOperator(task_id='train_model',
        bash_command='python3 /home/anton/mlops3/scripts/train_model.py',
        dag=dag)
    ...
    test_model = BashOperator(task_id='test_model',
        bash_command='python3 /home/anton/mlops3/scripts/test_model.py',
        dag=dag)
